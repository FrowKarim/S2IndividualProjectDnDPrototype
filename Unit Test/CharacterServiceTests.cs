...
namespace LogicLayer.Tests.Services
{
    public class CharacterServiceTests
    {
        ...
        public void GetCharacter_WithValidCharacterID_ReturnsCharacter()
        {
            ...
            Xunit.Assert.Equal(expectedCharacter.Id, result.Id);
            Xunit.Assert.Equal(expectedCharacter.Name, result.Name);
        ...
        public void UpdateCharacter_WithValidCharacter_ReturnsUpdatedCharacter()
        {
            ...
            // Assert
            Xunit.Assert.NotNull(result);
            Xunit.Assert.Equal(character.Id, result.Id);
            Xunit.Assert.Equal(character.currentHealth, result.currentHealth);
        ...
        public void UpdateCharacter_WithHealthStats_UpdatesCurrentHealth()
        {
            ...
            // Assert
            Xunit.Assert.Equal(75, result.currentHealth);
            Xunit.Assert.Equal(40, result.currentStrength);
        }
        ...
        public void GetCharactersByCampaign_WithValidCampaignID_ReturnsCharacterList()
        {
            ...
            Xunit.Assert.Equal(expectedCharacters, result);
